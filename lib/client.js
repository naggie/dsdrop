...
exports.TOKEN_INVALID = 'Session token is no longer valid. Login required.'
	...
	hashfile(filepath,function(err,hash) {
		...
		var r = request.post(exports.url+'/instant-upload', function(err,httpResponse,body) {
			...
			if (httpResponse.statusCode == 403)
				return done(exports.TOKEN_INVALID)
...
exports.describe = function(done) {
	if (!exports.url) return done('Client library: Server URL not set')
