...
exports.add = function (instance, done) {
	...
	rclient.incrby('total_upload_count',1)
}
...
exports.extract = function(token,done) {
	...
	rclient.hgetall('instance:'+token,function(err,instance) {
		...
		rclient.incrby('total_download_count',1)
	...
	rclient.multi()
		...
		.exec(function(err,replies) {
			...
			for (var i in bits) {
				...
				storage_used  : (replies[1]/(1024*1024*1024)).toFixed(0),
				...
				transferred          :  (replies[2]/(1024*1024*1024)).toFixed(0),
