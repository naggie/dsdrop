...
var Main = function() {
	...
	var constructor = function() {
		// ...when everything is done, whatever is using the instance
		// can begin. Emit errors here, and as long as this is properly
		// asynchronous, they will be received by a listener defined
		// after instantiation. Otherwise, errors may be emitted before
		// a receiver is listening and the application will fall over;
		// besides, synchronous code needs exception based error
		// handling. Check instantiation parameters here.
		self.emit('ready')
	}
	...
	// now that everything is defined, it's safe to call the constructor
	// with parameters from the instantiation.
